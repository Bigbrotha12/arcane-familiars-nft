        ...
        {Array.from({ length: MAX_STATUS_SLOTS }).map((_, i) => {
          ...
          return (
            <div
              ...
              className="relative flex h-[26px] w-full items-center justify-center"
            >
              {effect && (
                <>
                  <div className="flex h-full w-full items-center justify-center rounded-md bg-[#2D2A5E] text-[14px]">
                    {effect.icon}
                  </div>
