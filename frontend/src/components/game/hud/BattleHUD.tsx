...
function BattleHUD({ snapshot, outcome, onAction, onContinue }: BattleHUDProps) {
  ...
  if (snapshot.currentScene !== 'battle' || !snapshot.enemy || !snapshot.phase || snapshot.phase === 'connecting') {
    return null;
  }
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 z-10">
        ...
        {enemy && (
          <div className="absolute" style={{ left: '16px', top: '16px' }}>
        ...
        {activeFamiliar && (
          <div className="absolute" style={{ right: '16px', bottom: '240px' }}>
