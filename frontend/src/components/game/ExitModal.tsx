    ...
    return (
      ...
      >
        <div className="text-center">
          <p className="font-display text-lg font-semibold text-[#F0EFFF] mb-2">Unsaved Progress</p>
  ...
  return (
    <Modal open={open} onClose={onCancel} title="Leave Game?" hud>
      <div className="flex flex-col gap-3">
        <Button className="w-full" size="md" onClick={onSaveAndExit} disabled={saving}>
          {saving ? 'Saving...' : 'Save & Exit'}
        </Button>
        <Button variant="ghost" size="md" className="w-full" onClick={() => setConfirmDangerous(true)}>
          Exit Without Saving
        </Button>
